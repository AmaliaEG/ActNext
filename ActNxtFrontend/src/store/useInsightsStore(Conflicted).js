...
const useInsightStore = create((set, get) => ({
        ...
        loadInsights: async () => {
            try {
                ...
                ...item,
                dateAssigned: ensureDate(item.DtCreate),
                }));
        ...
        setInsights: async (data) => {
            try {
                ...
                ...item,
                dateAssigned: ensureDate(item.DtCreate || item.dateAssigned),
                }));

                await AsyncStorage.setItem('insights', JSON.stringify(processed));
                set({ insights: processed });
            } catch (error) {
